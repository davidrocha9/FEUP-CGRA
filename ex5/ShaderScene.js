	...
	init(application) {
		...
		*/
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/ex1.1.vert", "shaders/ex1.1.frag"),
			new CGFshader(this.gl, "shaders/ex1.2.vert", "shaders/ex1.2.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/ex1.3.frag"),
